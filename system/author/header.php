...
//Datos de autor
$query = "SELECT * FROM author WHERE iduser=$user";
$result2 = mysqli_query($dbc, $query);
$row_author = mysqli_fetch_assoc($result2);


$titulo = $row_usuario['email'];
$usuario = $row_usuario['email'];

$idauthor = $row_author['idautor'];

$degree = $row_author['degree'];
$name = $row_author['name'];
$lastname = $row_author['lastName'];
$familyname = $row_author['familyName'];

$key = $row_author['public_key'];

$institution = $row_author['institution'];

$email = $row_author['email'];

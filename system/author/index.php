  ...
  <div class="panel-body">
    <div class="row">
      ...
      <div class="col-md-6 text-center">
        ...
        <p><a href="subir.php" class="btn btn-success">New Article</a></p>

        <p>Public key: <?= $key ?> </p>
      </div>

      <div class="col-md-6 text-center">
        <h3>Status of submitted articles</h3>
        ...
        <table class="table table-bordered">
          ...
          <tr>
            ...
            <td><button data-toggle="modal" data-target="#view-modal" data-id="<?= $row_article['idarticle']?>" id="getArticle" class="btn btn-sm btn-info" data-toggle="tooltip" data-placement="top" title="Ver datos">More...</button>

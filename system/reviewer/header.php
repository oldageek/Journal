...
//Datos de rol
$query = "SELECT * FROM rol WHERE iduser=$id AND rol=3";
$result2 = mysqli_query($dbc, $query);
$row_revisor = mysqli_fetch_assoc($result2);
 
$idrevisor = $row_revisor['idrol'];
$degree = $row_revisor['degree'];
$name = $row_revisor['name'];
$lastname = $row_revisor['lastName'];
$familyname = $row_revisor['familyName'];

$institution = $row_revisor['university'];
